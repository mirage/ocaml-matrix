...
struct
  ...
  struct
    ...
    let encoding =
      let to_tuple t =
        t.kty, t.key_ops, t.alg, t.k, t.ext
      in
      let of_tuple v =
  ...
  let encoding =
    ...
    let with_tuple =
      obj7
        ...
        (opt "thumbnail_info" Thumbnail.encoding)
    in
    conv to_tuple of_tuple with_tuple
end
...
struct
  ...
  let encoding =
    let to_tuple t =
      t.duration, t.h, t.w, t.mimetype, t.size, t.thumbnail_url, t.thumbnail_file, t.thumbnail_info
    in
    let of_tuple v =
      let duration, h, w, mimetype, size, thumbnail_url, thumbnail_file, thumbnail_info = v in
...
struct
  ...
  let encoding =
    let to_tuple t =
      t.thumbnail_url, t.thumbnail_file, t.thumbnail_info
    in
    let of_tuple v =
