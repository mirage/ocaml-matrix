...
module Events : sig
  module Event_content : sig
    ...
    module Member : sig
      module Third_party_invite : sig
        module Signed : sig
          type%accessor t = {mxid: string; signature: unit; token: string}
    ...
    module Third_party_invite : sig
      module Public_key : sig
        type%accessor t = {key_validity_url: string option; public_key: string}
    ...
    module Encrypted : sig
      ...
      module Cyphertext : sig
        module Cyphertext_info : sig
    ...
    module Message : sig
      ...
      module Sticker : sig
        type%accessor t = {body: string; info: Message.Image.t; url: string}
    ...
    module Call : sig
      ...
      module Answer : sig
        ...
        type%accessor t = {call_id: string; answer: Answer.t; version: int}
