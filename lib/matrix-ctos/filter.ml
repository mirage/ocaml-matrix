...
struct
  ...
  let encoding =
    let to_tuple t =
      t.limit, t.not_senders, t.not_types, t.senders, t.types
    in
    let of_tuple v =
      let limit, not_senders, not_types, senders, types = v in
      { limit; not_senders; not_types; senders; types }
    in
    let with_tuple =
      obj5
        (opt "limit" int)
...
struct
  ...
  let encoding =
    let to_tuple t =
      t.not_rooms, t.rooms, t.ephemeral, t.include_leave, t.state, t.timeline, t.account_data
    in
    let of_tuple v =
      let not_rooms, rooms, ephemeral, include_leave, state, timeline, account_data = v in
    ...
    let with_tuple =
      obj7
        ...
        (opt "account_data" Room_event_filter.encoding)
    in
    conv to_tuple of_tuple with_tuple
end
...
struct
  ...
  let encoding =
    let to_tuple t =
      t.event_fields, t.event_format, t.presence, t.account_data, t.room
    in
    let of_tuple v =
