    ...
    let encoding =
      ...
      let with_tuple =
        obj5
          ...
          (req "email" string)
          (req "send_attempt" int)
          (opt "next_link" string)
    ...
    struct
      ...
      let encoding =
        ...
        let with_tuple =
          obj2
            (req "auth"
              Authentication.Password.V1.encoding)
            (req "new_password"
              string)
        in
        conv to_tuple of_tuple with_tuple
...
struct
  ...
  struct
    ...
    let encoding =
      ...
      let with_tuple =
        obj1
          (req "id_server_unbind_result" Unbind_result.encoding)
      in
      conv to_tuple of_tuple with_tuple
  end
  ...
  struct
    ...
    struct
      ...
      struct
        ...
        let encoding =
          let to_tuple t =
            t.medium, t.address, t.validated_at, t.added_at
          in
          let of_tuple v =
      ...
      let encoding =
        ...
        let with_tuple =
          obj1
            (req "threepids" (list Third_party_identifier.encoding))
        in
        conv to_tuple of_tuple with_tuple
    end
  ...
  struct
    ...
    struct
      ...
      struct
        ...
        let encoding =
          let to_tuple t =
            t.client_secret, t.id_server, t.sid
          in
          let of_tuple v =
            let client_secret, id_server, sid = v in
            { client_secret; id_server; sid }
          in
          let with_tuple =
            obj3
              (req "client_secret" string)
      ...
      let encoding =
        let to_tuple t =
          t.three_pid_creds, t.bind
        in
        let of_tuple v =
          let three_pid_creds, bind = v in
          { three_pid_creds; bind }
        in
        let with_tuple =
          obj2
