...
struct
  ...
  let path scope kind rule_id = "_matrix/client/r0/pushrules/" ^ scope ^ "/" ^ (Kind.to_string kind) ^ "/" ^ rule_id
...
struct
  ...
  struct
    ...
    let args t =
      ...
      let l =
        match t.before with
          | None -> l
          | Some before -> ("before", [before])::l
      in
      let l =
        match t.after with
          | None -> l
          | Some after -> ("after", [after])::l
      in
      l
  end
  ...
  struct
    ...
    let encoding =
      let to_tuple t =
        t.actions, t.conditions, t.pattern
      in
      let of_tuple v =
...
struct
  ...
  let path scope kind rule_id = "_matrix/client/r0/pushrules/" ^ scope ^ "/" ^ (Kind.to_string kind) ^ "/" ^ rule_id ^ "/" ^ "enabled"
...
struct
  ...
  let path scope kind rule_id = "_matrix/client/r0/pushrules/" ^ scope ^ "/" ^ (Kind.to_string kind) ^ "/" ^ rule_id ^ "/" ^ "actions"
